...
1. [What is Code Coverage](#1-what-is-code-coverage-2-min) (2 min)
2. [Install the Code Coverage package](#2-install-the-code-coverage-package-2-min) (2 min)
3. [Install the Asteroids sample project](#3-install-the-asteroids-sample-project-1-min) (1 min)
4. [Enable Code Coverage](#4-enable-code-coverage-1-min) (1 min)
5. [Understanding the game code: Shoot() function](#5-understanding-the-game-code-shoot-function-4-min) (4 min)
6. [Generate a Coverage report from PlayMode tests](#6-generate-a-coverage-report-from-playmode-tests-3-min) (3 min)
7. [Add Weapon tests to improve coverage](#7-add-weapon-tests-to-improve-coverage-3-min) (3 min)
8. [Add a test for the LaserController](#8-add-a-test-for-the-lasercontroller-4-min) (4 min)
9. [Clear the coverage data](#9-clear-the-coverage-data-1-min) (1 min)
10. [Generate a Coverage report using Coverage Recording](#10-generate-a-coverage-report-using-coverage-recording-4-min) (4 min)
11. [Bonus task](#11-bonus-task-5-8-min) (5-8 min)
...
2. Find the **Samples** section in the package details (right hand side) and select **Import** next to **Code Coverage Tutorial**.<br><br>
   ![Import Asteroids project](images/quickguide/import_sample.png)<br><br>**Note:** The **Code Coverage Tutorial** sample depends on the [Input System](https://docs.unity3d.com/Packages/com.unity.inputsystem@latest) package. Make sure this package is installed before importing the sample and that **Active Input Handling** is set to **Input System Package (New)** in **Project Settings** > **Player** > **Other Settings**.
...
2. Go to the **\_18_LaserFiresSuccessfully** test in line 225.
...
Complete the [Bonus Task](#11-bonus-task-5-8-min) at the end of the tutorial to get 100% coverage!
...
**Suggested name:** \_19_LaserFiresAndIsDestroyedAfterTwoSeconds.<br>
